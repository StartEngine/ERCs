...
author: John Shiple (@johnshiple), Howard Marks (@howardmarks) <howard@startengine.com>, David Zhang <david@startengine.com>, Devender Gollapally (@devender-startengine) <devender@startengine.com>, Joe (@se-joe) <joe@startengine.com>, Jordan Jahja (@jordan-jahja) <jordan.jahja@startengine.com>
...
interface IERC1450 is IERC20 {
    ...
    /**
     * @notice Update the transfer agent address (restricted after initial lock)
     * @param newTransferAgent Address of the new transfer agent
     * @dev This function should be restricted or disabled after initial setup for security
     */

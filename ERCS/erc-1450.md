...
The design decision to give the RTA exclusive control over `transferOwnership` (preventing even the issuer from changing it) is intentional and based on regulatory requirements:
